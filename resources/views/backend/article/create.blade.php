...
@section('content')
    <section class="content-header">
        <h1>
            Thêm mới tin tức <a href="{{route('admin.article.index')}}" class="btn btn-success pull-right"><i class="fa fa-list"></i> Danh Sách</a>
        </h1>
    </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div style="margin: 30px">
                                        <div class="checkbox">
                                            <input type="checkbox" value="1" name="is_new"> Tin tức mới
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
