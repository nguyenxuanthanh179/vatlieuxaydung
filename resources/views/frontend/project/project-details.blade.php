    ...
    <main class="main">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <div class="container">
                        <p class="blog">DỰ ÁN</p>
                        <h3 class="main__tiltle main__color">{{$project->title}}</h3>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="product-details__send-comment mt-3">
                                        ...
                                        <div class="form__contact">
                                            <form id="contact-form" action="{{route('shop.postComment',['slug'=>$project->slug])}}" method="post" enctype="multipart/form-data">
                                                @csrf
